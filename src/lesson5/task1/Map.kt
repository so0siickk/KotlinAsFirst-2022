...
//      answer.getOrPut(value) { mutableListOf(buildString { answer[value] }) }.add(key)
        if (answer[value] != null) answer.getOrPut(value) { mutableListOf(buildString { answer[value] }) }.add(key)
